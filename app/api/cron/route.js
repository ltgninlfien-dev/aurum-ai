...
export async function GET(request) {
  ...
  try {
    ...
    // n'est ouverte pendant les 15 premières heures après la réouverture du marché
    // (lundi 00h→15h UTC). Le shadow continue de trader normalement sans cette option.
